...
/**
 * Agora AccessToken2 Generator (Version 007)
 *
 * Token versi 007 adalah standar terbaru yang dibutuhkan oleh
 * Agora RTC SDK versi 4.x+ (Flutter agora_rtc_engine 6.x).
 *
 * Perbedaan utama dari versi 006:
 * - Menggunakan zlib compression
 * - Mendukung multi-service (RTC, RTM, Chat, dll)
 * - Privilege per-service (bukan global)
 * - Format signing yang berbeda (double HMAC)
 *
